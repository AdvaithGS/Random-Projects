...
image = str(soup.find('img',attrs = {'alt':'Image of the most recently started Deployment State of Webb - described in following text'}))

image_link =  'https://jwst.nasa.gov/'+ image[image.rfind('src=') + 5 : image.rfind('/')]
print(image_link)
